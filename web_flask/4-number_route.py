...
the value of the 'text' variable
   ...
   for 'text' is "is cool".
5. The '/number/<n>' route displays "n is a number" only if
    'n' is an integer.
...
Examples:
    ...
    - Visit http://0.0.0.0:5000/python/ in your browser to see
    "Python is cool" (default).
    - Visit http://0.0.0.0:5000/number/python in your browser
    to see a 404 error.
...
def number(n):
    ...
    Returns:
        str: A message displaying "n is a number" if 'n' is an integer,
            404 error otherwise.
    """
